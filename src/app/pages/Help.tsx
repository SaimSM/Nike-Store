    ...
    <div className="max-w-screen-2xl mx-auto">
      <div className="form text-center my-6 ">
        ...
        <div className="flex justify-center">
          <input
            className=" w-96 text-xs px-5  py-3 my-2  "
            type="text"
          ...
          <button className="relative right-10">
            {" "}
            <svg
              className="  pl-2 block top-3 right-[500px]  text-gray-400 "
              width="30"
              height="30"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div className="my-4 py-4">
              ...
              <div>
                ...
                <span>
                  ...
                  latest <br /> OS, be signed in to your iCloud account and have
                  a supported card in your Wallet. Additionally, {`you'll`} need
                  to use <br /> Safari to use Apple Pay on Nike.com.
                </span>{" "}
                <br />
                <br />
              </div>
