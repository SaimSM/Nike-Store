    ...
    <div className="max-w-screen-2xl mx-auto">
      <div className="  flex justify-center lg:justify-between ">
        <div className="pt-8 px-10 ">
          <div className="">
            <span className="text-2xl font-semibold my-6">
              Find a Nike Store
            </span>
          </div>
          ...
          <div className="my-5">
            ...
            <br />
            <span className="text-gray-500">650 5th Ave.</span>
            <br />
            <span className="text-gray-500">New York, NY, 10019, US</span>
            <br />
            <span className="text-red-500">
              Closed <span className="text-gray-500">• Opens at 11:00 am</span>
            </span>
          </div>
          <hr />
          ...
          <div className="my-5">
            <span className="font-semibold ">Nike By Upper East Side</span>
            <br />
            <span className="text-gray-500">1131 3rd Ave.</span>
            <br />
            <span className="text-gray-500">New York, NY, 10065, US</span>
            <br />
            <span className="text-red-500">
              Closed <span className="text-gray-500">• Opens at 11:00 am</span>
            </span>
          ...
          <div className="my-5">
            <span className="font-semibold ">Nike By Flatiron </span>
            <br />
            <span className="text-gray-500">156 Fifth Ave.</span>
            <br />
            <span className="text-gray-500">New York, NY, 10010, US</span>
            <br />
            <span className="text-red-500">
              Closed <span className="text-gray-500">• Opens at 11:00 am</span>
            </span>
